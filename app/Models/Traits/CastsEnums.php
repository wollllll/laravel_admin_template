...
trait CastsEnums
{
    ...
    public function getAttribute(string $key)
    {
        ...
        if (is_null($value) && in_array($key, $this->fillable) && array_key_exists($key, $this->enumCasts)) {
            $value = new $this->enumCasts[$key]();
        }
     ...
     * @return $this
     */
    public function setAttribute(string $key, $value): CastsEnums
    {
        if (!is_null($value) && $this->hasEnumCast($key)) {
     ...
     */
    protected function castToEnum(string $key, $value): ?Enum
    {
